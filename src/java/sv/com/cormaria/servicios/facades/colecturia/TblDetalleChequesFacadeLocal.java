...
public interface TblDetalleChequesFacadeLocal {
    ...
    void create(TblDetalleCheques tblDetalleCheques) throws ClinicaModelexception;

    void edit(TblDetalleCheques tblDetalleCheques) throws ClinicaModelexception;
