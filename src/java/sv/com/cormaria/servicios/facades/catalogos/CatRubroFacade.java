 ...
 */
@Stateless
public class CatRubroFacade extends AbstractFacade<CatRubro> implements CatRubroFacadeLocal {
    ...
    public CatRubroFacade() {
        super(CatRubro.class);
    }

    @Override
    public List<CatRubro> findAll() throws ClinicaModelexception {
        try{
            Query q = em.createNamedQuery("CatRubro.findAll");
    ...
    public int count() throws ClinicaModelexception {
        try{
            Query q = em.createQuery("Select count(*) from CatRubro");
