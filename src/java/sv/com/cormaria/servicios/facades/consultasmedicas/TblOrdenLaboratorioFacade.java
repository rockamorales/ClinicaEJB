 ...
 */
@Stateless
public class TblOrdenLaboratorioFacade extends AbstractFacade<TblOrdenLaboratorio> implements TblOrdenLaboratorioFacadeLocal {
    ...
    @Override
    public List<TblOrdenLaboratorio> findRange(int[] range) throws ClinicaModelexception {
        throw new UnsupportedOperationException("Not supported yet.");
    }
