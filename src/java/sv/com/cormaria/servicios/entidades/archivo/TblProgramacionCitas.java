...
@NamedQueries({
    ...
    @NamedQuery(name = "TblProgramacionCitas.findByRange", query = "SELECT t FROM TblProgramacionCitas t where t.fecCita between :startDate and :endDate order by t.fecCita, t.horCita")
})
